...
/*
 * main.cc
 * Copyright (C) 2020 mark <mark@OpenSUSE1.home>
 * 
 * guitartuner is free software: you can redistribute it and/or modify it
 * under the terms of the GNU General Public License as published by the
 * Free Software Foundation, either version 3 of the License, or
 * (at your option) any later version.
 * 
 * guitartuner is distributed in the hope that it will be useful, but
...
/* #define UI_FILE PACKAGE_DATA_DIR"/ui/guitartuner.ui" */
